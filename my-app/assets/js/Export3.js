function showLowStockExport() {
    ...
    Swal.fire({
                ...
                <form id="exportLowStockForm">
                  <div class="mb-3">
                    ...
                    <select name="location" id="locationSelectLowStock" class="form-select dropdown-style">
                        ...
                        <option value="Nakhon Si Thammarat">Nakhon Si Thammarat</option> <!-- Fixed spelling -->
      ...
      didOpen: () => {
        ...
        endDatePickerLowStock = flatpickr("#end-date-lowstock", {
            minDate: "2020-01-01",  // Initial min date
            dateFormat: "Y-m-d",
            position: "below",
        });
  ...
  function saveLowStockExport() {
    ...
    // Modified endpoint for low stock report
    ...
    setTimeout(() => {
      Swal.close();
      Swal.fire({
        title: "ดาวน์โหลดรายงานสต็อกต่ำเรียบร้อย",
        icon: "success",
        confirmButtonText: "ตกลง"
      });
    }, 2000);
